...
class MazeGenerator:
    ...
    def __init__(self, width: int, height: int, perfect: bool = False, seed: Optional[int] = None) -> None:
        self.width = width
        self.height = height
    ...
    def _false_maze(self) -> None:
        self._perfect_maze()
        utils._remove_dead_ends(self.wall, self.width, self.height, self._rnd_seed)
        utils._ensure_key_cells_open(self.wall, self.width, self.height, self._rnd_seed)